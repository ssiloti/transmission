...
tr_sessionGetDefaultSettings (tr_variant * d)
{
    ...
    tr_variantDictAddBool (d, TR_KEY_tls_enabled,                     false);
...
tr_sessionGetSettings (tr_session * s, tr_variant * d)
{
  ...
  tr_variantDictAddBool (d, TR_KEY_tls_enabled,                  s->isTLSEnabled);
...
sessionSetImpl (void * vdata)
{
    ...
    if (tr_variantDictFindBool (settings, TR_KEY_tls_enabled, &boolVal))
